...
CONTENT_LENGTH_WEIGHT_TARGET_WORDS = max(
    _get_int_env("SENTIFY_CONTENT_LENGTH_WEIGHT_TARGET_WORDS", 400),
    0,
)
CONTENT_LENGTH_WEIGHT_MIN = max(
    _get_float_env("SENTIFY_CONTENT_LENGTH_WEIGHT_MIN", 0.75),
    0.0,
)
CONTENT_LENGTH_WEIGHT_MAX = max(
    _get_float_env("SENTIFY_CONTENT_LENGTH_WEIGHT_MAX", 1.25),
    CONTENT_LENGTH_WEIGHT_MIN,
)

DEFAULT_SENTIMENT_MODEL_ID = "marcev/financebert"
DEBUG_MODE = _get_bool_env("SENTIFY_DEBUG")
